...
/**
 * Bumped by every expense/savings create/update/delete/confirm call site.
 * Screens that must stay live without a manual refresh (e.g. Budgets,
 * Dashboard) subscribe to the relevant counter as a useEffect dependency
